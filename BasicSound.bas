...
' that can be generated by the BASIC Stamp using FREQOUT and DTMFOUT.  This ' program works best when played through an amplifier. 
' ------------------------------------------------------------------------------ 
' I/O Definitions 
' ------------------------------------------------------------------------------ 
...
Phone_Busy: 
  PAUSE 1000 
  DEBUG CR, " - busy...", CR  onTime = 400 */ ScaleT 
  note1 = 480 */ ScaleF 
  note2 = 620 */ ScaleF 
  FOR x = 1 TO 8 
